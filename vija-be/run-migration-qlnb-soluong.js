...
async function runMigration() {
  console.log('========================================');
  console.log('Migration: Add so_luong to qlnb');
  console.log('========================================\n');
  ...
  try {
    ...
    const [columns] = await connection.query(
      "SHOW COLUMNS FROM qlnb LIKE 'so_luong'"
    );
    ...
    await connection.query('ALTER TABLE qlnb ADD COLUMN so_luong INT DEFAULT 0 AFTER ma_bv');
